...
- **Teams:** Kent Island Varsity Bucs (away) / Cambridge-South Dorchester (home)
- **Date:** Fri Apr 24, 4:00 PM - 5:00 PM ET
- **Game Type:** Not labeled
- **Final Score:** KNTS 15, CMBR 2
- **Innings Played:** 6 (game ended after bottom 6th)
...
**Team Totals:**
- Kent Island Varsity Bucs: R=15, H=11, E=1  
- Cambridge-South Dorchester: R=2, H=5, E=2
...
| 4 | 5 | Bottom | T Calnon | Walk | is intentionally walked, G decker pitching, M Bolak remains at 2nd | | | |
...
| 14 | 7 | Top | V Wong | Single | singles on a line drive to pitcher V Cagle | | | |
| 15 | 7 | Top | G decker | Home Run | homers on a line drive to left field | | 1 | |
...
**Flag #1:** Undocumented pitching transition — G decker pitching is first mentioned in play #3 without a preceding "Lineup changed" entry.

**Flag #2:** Undocumented pitching transition — V Cagle pitching is first mentioned in play #15 without a preceding "Lineup changed" entry.

**Flag #3:** Line score vs. log contradiction — The line score shows Cambridge-South Dorchester with "X" in the 6th inning, but the play log contains three plate appearances for the bottom of the 6th inning (#9-11).

### Mandatory Verification — Run Totals

**Play-by-play log totals by inning:**
- Kent Island: Inning 5: 0, Inning 6: 0, Inning 7: 1 = 1 total
- Cambridge-South Dorchester: Inning 5: 0, Inning 6: 0 = 0 total

**Line score inning totals:**
- Kent Island: 3+5+0+5+2+0 = 15 total
- Cambridge-South Dorchester: 1+0+1+0+0+X = 2 total

**Reported team R totals:**
- Kent Island: 15
- Cambridge-South Dorchester: 2

**Analysis:** The play-by-play log only covers portions of innings 5-7, showing 1 run for Kent Island and 0 for Cambridge-South Dorchester. The line score and reported totals both show Kent Island 15, Cambridge-South Dorchester 2. This represents a major discrepancy as the play log appears to be incomplete, missing most of the game action from innings 1-4 and partial coverage of later innings.

### Mandatory Verification — Hit Totals

**Hits from play log:**
- Play #1 (M Bolak single), Play #9 (M Guard single), Play #14 (V Wong single), Play #15 (G decker home run) = 4 total hits

**Reported team H totals:**
- Kent Island: 11
- Cambridge-South Dorchester: 5

**Analysis:** The play log shows 4 hits total (3 for Kent Island, 1 for Cambridge-South Dorchester) while the reported totals show 16 hits combined (11 + 5). This conflicts significantly, consistent with the play log being incomplete.

### Mandatory Verification — Errors

**Errors from play log:** No errors explicitly mentioned in the available play descriptions.

**Reported team E totals:**
- Kent Island: 1
- Cambridge-South Dorchester: 2

**Analysis:** The play log shows 0 errors while the reported totals show 3 errors combined. This conflicts, again consistent with incomplete log coverage.