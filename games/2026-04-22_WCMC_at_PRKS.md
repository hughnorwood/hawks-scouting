...
- **Date:** Wed Apr 22, 4:00 PM - 5:00 PM ET
- **Game Type:** Not labeled
- **Final Score:** WCMC 3, PRKS 14
- **Innings Played:** 5 complete (home team did not bat in 5th due to mercy rule)
...
| 11 | 6 | Bottom | C England | Double Play | grounds into a double play, shortstop H Lagasse to first baseman S Tarantino, M Guard out advancing to 2nd, C England doubled off at 1st | 3 | | |
...
**Flag #1:** Undocumented pitching transition - Play #3: G decker identified as pitcher without preceding "Lineup changed" entry.

**Flag #2:** Undocumented pitching transition - Play #16: V Cagle identified as pitcher without preceding "Lineup changed" entry.

**Flag #3:** Scorer correction notation - Play #16: Pinch runner R Legg substituted for "extra hitter V Wong" during the pitch sequence, suggesting V Wong's status was being corrected mid-play.

### Mandatory Verification — Run Totals

**Play-by-play runs by inning:**
- WCMC: Inning 7 = 1 run (Play #15)
- PRKS: No runs recorded in available play log

**Line score totals:**
- WCMC: 1+2+0+0+0 = 3 runs
- PRKS: 7+2+4+1+X = 14 runs

**Reported team R totals:**
- WCMC: 3 runs
- PRKS: 14 runs

**Conflict:** The play-by-play log only covers partial innings 5-7 and records only 1 run for WCMC in the 7th inning. The line score and team totals show WCMC with 3 total runs and PRKS with 14 total runs, but the available play log does not contain the earlier innings where most runs were scored.
...
**Count:** WCMC = 2 hits, PRKS = 2 hits from available log

**Reported team H totals:**
- WCMC: 3 hits
- PRKS: 8 hits

**Conflict:** Play log shows 2 hits each for both teams, but reported totals show WCMC 3 hits and PRKS 8 hits. The discrepancy reflects that the available log covers only partial innings 5-7.

### Mandatory Verification — Errors

**Errors identified in play log:** None explicitly noted in the available portion.

**Reported team E totals:**
- WCMC: 2 errors
- PRKS: 3 errors

**Conflict:** No errors recorded in the available play log portion, but team totals show WCMC 2 errors and PRKS 3 errors.